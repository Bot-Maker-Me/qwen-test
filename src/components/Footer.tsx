...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/10">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent to-deep/50" />
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="w-10 h-10 glass-card-hover rounded-full flex items-center justify-center text-white/50 hover:text-white transition-colors"
                >
                  {social.icon}
                </motion.a>
              ))}
